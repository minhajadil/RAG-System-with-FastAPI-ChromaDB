...
In this project, I'm going to build a  RAG pipeline using FastAPI.
...
3. will run the script and verify my knowledge base is built.
...
2. searchs for similar level vectors in it's database which is closest to the query.
